...
　　 　LUCAS
　　　LUCAS
{puti}Update   : {biru} SCRIPT ABID
{puti}Script  : {biru}CRACK FB
{puti}pembuat : {biru}ABID PERUDAL FB
{puti}Status   : {biru}PREMIUM NI DEK
{puti}Version  : {biru} 1.1.2 LUCAS                                                                                                               ''')
#kukis
def login():
	os.system('clear')
	banner()
		...
		'viewport-width': f'{str(rr(300,999))}',
	     ...
	     'accept-language': 'id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7',
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print(f"⌲ Mode: FinoDafaresta|SUCCES ")
				print(f'{hijo}{ua}')
